...
void export_PotentialPairHsu(pybind11::module& m);
...
void export_PotentialPairHsuGPU(pybind11::module& m);
...
PYBIND11_MODULE(_md, m)
    ...
    export_SineSqAngleForceCompute(m);
    ...
    export_SineSqAngleForceComputeGPU(m);
